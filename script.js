function changeObekti() {
    ...
    obekti.style.color = "#99D19C"
    obekti.style.borderBlockColor = "#99D19C"
    ...
    let registraciq = document.getElementById('registraciq')
...
function changeKarta() {
    let karta = document.getElementById('karta')
    karta.style.color = "#99D19C"
    karta.style.borderBlockColor = "#99D19C"
...
function changeRegistraciq() {
    let registraciq = document.getElementById('registraciq')
    registraciq.style.color = "#99D19C"
    registraciq.style.borderBlockColor = "#99D19C"
    console.log("changed 2")
